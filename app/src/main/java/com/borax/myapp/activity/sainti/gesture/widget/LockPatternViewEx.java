...
package com.borax.myapp.activity.sainti.gesture.widget;
...
//        }// if
    ...
    private void drawCircle(Canvas canvas, float centerX, float centerY,
    	...
    	if(partOfPattern){
    		npaint.setColor(getCurrentColor(partOfPattern));
    	}else{
    		npaint.setColor(Color.parseColor("#00000000"));
    	}
        canvas.drawCircle(centerX,centerY, 30, npaint);  
          
        Paint npaint1 = new Paint();
        npaint1.setAntiAlias(true); 
    	
    	if(partOfPattern){
    		npaint1.setColor(getCurrentColor(partOfPattern));
    		npaint1.setAlpha(120);
    	}else{
    		npaint1.setColor(Color.parseColor("#00000000"));
    	}
    	
        canvas.drawCircle(centerX,centerY, 65, npaint1);
          
        //����Բ��  
        
        mPaint.setColor(getCurrentColor(partOfPattern));
        mPaint.setStrokeWidth(5);  
        canvas.drawCircle(centerX,centerY, 65, mPaint);  
          
//        //������Բ  
//        mPaint.setColor(getCurrentColor(partOfPattern));
//        mPaint.setStrokeWidth(2);  
//        canvas.drawCircle(centerX,centerY, 50+size / 2+6, mPaint);  
//    	
    	///////////////////////////////
//        mPaint.setColor(getCurrentColor(partOfPattern));
